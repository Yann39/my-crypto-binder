...
public class ExchangeCardViewHolder extends RecyclerView.ViewHolder {
    ...
    public TextView exchange_publicApiKey_textView;
    public TextView exchange_privateApiKey_textView;
    ...
    public ExchangeCardViewHolder(View v) {
        ...
        exchange_publicApiKey_textView = v.findViewById(R.id.exchange_card_exchange_publicApiKey);
        exchange_privateApiKey_textView = v.findViewById(R.id.exchange_card_exchange_privateApiKey);
