...
public class AddTransactionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currencyListViewModel.getCurrencyList().observe(AddTransactionActivity.this, new Observer<List<Currency>>() {
            @Override
        ...
        exchangeListViewModel.getExchangeList().observe(AddTransactionActivity.this, new Observer<List<Exchange>>() {
            @Override
