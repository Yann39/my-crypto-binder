...
public class SectionItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SectionItemDecoration(int headerHeight, boolean sticky) {
    ...
    private View inflateHeaderView(RecyclerView parent) {
        return LayoutInflater.from(parent.getContext()).inflate(R.layout.section_header_currency, parent, false);
    }
