...
@Entity(tableName = "bittrex_withdrawals")
public class BittrexWithdrawal {
    ...
    public BittrexWithdrawal(String paymentUuid, String currency, Double amount, String address, Date opened, boolean authorized, boolean pendingPayment, Double txCost, String txId, boolean canceled, boolean invalidAddress) {
